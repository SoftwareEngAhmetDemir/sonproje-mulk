...
// if(props.option.images[0].substring('../public'.length))
    ...
    return (
             ...
             <div key={ims} className="productCard col-md-6 col-lg-4 col-sm-6 col-xs-12" onClick={()=>Go_Next(props)}>
    ...
    <li>{props.option.bank_id[0].label}'tan {props.option.city[0].label} {props.option.town[0].label}'de
    {props.option.props.Alan}m2 {props.option.props.Ticari}</li>
                     <li><i className="fas fa-map-marker-alt">
                     </i>{props.option.bank_id[0].label}-{props.option.city[0].label}-{props.option.town[0].label}'de
    {props.option.props.Alan}m2 {props.option.props.Ticari}</li>
                     <li>BRG</li>
                  </ul>
               </div>
