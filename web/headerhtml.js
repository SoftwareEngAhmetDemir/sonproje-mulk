...
import './style.css';
import BizKimiz from './HtmlComponents/BizKimiz';
import Iletisim from './HtmlComponents/Iletisim';
import NasilCalisir from './HtmlComponents/NasilCalisir';
import Profil from './HtmlComponents/Profil';
import Giris from './HtmlComponents/Giris';
import Uyeol from './HtmlComponents/Uyeol';
import Nedir from './HtmlComponents/Nedir';
import Listpage from './list_page';
import { Nav, Navbar } from 'react-bootstrap';
import AnaSayfa from './HtmlComponents/AnaSayfa';
  ...
  return (
    <Router>
      ...
      <div
        ...
        className='collapse navbar-collapse px-0 mx-0 w-100'
      ></div>
      ...
      <Switch>
        ...
        {/* <Route path="/filter/:plateNumber" exact>
                      <Listpage/>
        </Route> */}
        <Route path='/nedir' exact>
          <Nedir />
        </Route>
        <Route path='/nasilcalisir' exact>
          <NasilCalisir />
        </Route>
        <Route path='/iletisim' exact>
          <Iletisim />
        </Route>
        <Route path='/bizkimiz' exact>
          <BizKimiz />
        </Route>
